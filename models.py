...
class WeightedThreeHopGCN(nn.Module):
    def __init__(self, in_feats, hidden_feats, out_feats):
        ...
        args = get_args()
        self.linear_0 = nn.Linear(in_feats, args.hidden_dim)
        self.conv1 = dglnn.GraphConv(args.hidden_dim, hidden_feats, norm="both", weight=True)
    ...
    def forward(self, batched_graph, features, epoch, logger=None, batched_graph_base=None):
        ...
        print("adj_matrix")
        print(adj_matrix.to_dense()[:9, :9])  # Convert sparse tensor to dense before slicing
