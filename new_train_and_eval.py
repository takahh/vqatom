    ...
    for epoch in range(1, conf["max_epoch"] + 1):
        ...
        if conf["train_or_infer"] == "train":
            ...
            for idx, (adj_batch, attr_batch) in enumerate(dataloader):
                ...
                chunk_size = 200  # in 10,000 molecules
        ...
        np.savez(f"./sample_adj_{epoch}", sample_list_test[2].cpu()[:100, :100])
        ...
        np.savez(f"./sample_hop_type_{epoch}", sample_list_test[6].cpu()[:100])
