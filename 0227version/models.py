...
class AtomEmbedding(nn.Module):
    ...
    def forward(self, atom_inputs):
        ...
        x11 = self.func_embed_3(atom_inputs[:, 11].long())
        x12 = self.func_embed_3(atom_inputs[:, 12].long())
        x13 = self.func_embed_3(atom_inputs[:, 13].long())
        x14 = self.func_embed_3(atom_inputs[:, 14].long())
        x15 = self.func_embed_3(atom_inputs[:, 15].long())
        x16 = self.func_embed_3(atom_inputs[:, 16].long())
        x17 = self.func_embed_3(atom_inputs[:, 17].long())
        x18 = self.func_embed_3(atom_inputs[:, 18].long())
        x19 = self.func_embed_3(atom_inputs[:, 19].long())
        x20 = self.func_embed_3(atom_inputs[:, 20].long())
        x21 = self.func_embed_3(atom_inputs[:, 21].long())
        x22 = self.func_embed_3(atom_inputs[:, 22].long())
        x23 = self.func_embed_3(atom_inputs[:, 23].long())
        x24 = self.func_embed_3(atom_inputs[:, 24].long())
