...
def get_args():
    ...
    parser.add_argument(
        "--samples_latent_in_kmeans", type=int, default=20000, help="samples of latent in init_embed"
    )
    parser.add_argument(
        "--exp_setting",
        type=str,
    ...
    parser.add_argument("--learning_rate", type=float, default=3e-4) # default=0.0001)
