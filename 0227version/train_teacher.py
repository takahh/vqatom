...
def get_args():
    ...
    parser.add_argument("--checkpoint", action="store_true", help="Enable loading saved model")
...
def run(args):
    ...
    if (conf["train_or_infer"] != "train" and conf["train_or_infer"] != "hptune") or args["use_checkpoint"] == True:
