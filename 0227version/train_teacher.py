...
def run(args):
    ...
    if conf["train_or_infer"] != "train":
        ...
        best_epoch_dict = {'1000_64': 73, '1000_128': 80, '1000_256': 74, '1500_64': 80, '1500_128': 80, '1500_256': 72,
                           '2000_64': 75, '2000_128': 37, '2000_256': 73, '2500_256': 80, '1000_512': 49, '1500_512': 80,'2000_512': 80,
                           '2500_512': 50, '1000_1024': 53, '1500_1024': 49, '2000_1024': 29, '2500_1024': 20, '3000_1024': 15,
                           '3000_256': 88, '3000_512': 25, '3500_256': 35, '3500_512': 8, '3500_1024': 17}
        model.load_state_dict(torch.load(f"/vqatom/0227version/model_{best_epoch_dict[thiskey]}.pth", weights_only=False))
