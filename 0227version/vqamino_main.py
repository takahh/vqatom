...
from vqamino_models import VQAminoThreeHopGINE
...
def run(args):
    from vqamino_models import Model
    from vqamino_train_and_eval import run_inductive
    ...
    model = VQAminoThreeHopGINE(in_feats=args.hidden_dim, hidden_feats=args.hidden_dim, out_feats=args.hidden_dim, args=args)
    ...
    from vqamino_train_and_eval import run_infer_after_restore
    if args.train_or_infer == "hptune":
        ...
        run_infer_after_restore(conf, model, logger, "../data/model_epoch_3.pt")
